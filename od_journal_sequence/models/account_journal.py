...
class AccountJournal(models.Model):
    ...
    transfer_sequence_id = fields.Many2one('ir.sequence', string='Transfer Sequence',
                                  help="This field contains the information related to the numbering of the"
                                       " journal entries of this journal.",
                                  required=False, copy=False)
    receipt_sequence_id = fields.Many2one('ir.sequence', string='Receipt Sequence',
                                  help="This field contains the information related to the numbering of the"
                                       " journal entries of this journal.",
                                  required=False, copy=False)
    ...
    seq_code = fields.Char(string="Sequence")
