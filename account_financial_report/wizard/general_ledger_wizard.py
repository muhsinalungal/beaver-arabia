...
class GeneralLedgerReportWizard(models.TransientModel):
    ...
    show_department = fields.Boolean(
        string="Show Department")

    show_journal_code = fields.Boolean(
        string="Show journal")

    show_employee = fields.Boolean(
        string="Show employee")
    show_asset = fields.Boolean(
        string="Show Asset")
    show_accommodation = fields.Boolean(
        string="Show Accommodation")
    ...
    accommodation_ids = fields.Many2many(
        ...
        string="Filter Accommodation"
    )
    account_cost_center_ids = fields.Many2many(
        comodel_name="account.budget.post",
        string="Filter Cost Center"
    )

    journal_code_ids = fields.Many2many(
        comodel_name="journal.code",
        string="Filter Journal Code"
    )
    ...
    def _prepare_report_general_ledger(self):
        ...
        return {
            ...
            "show_department": self.show_department,
            "show_journal_code": self.show_journal_code,
            "show_employee": self.show_employee,
            "show_asset": self.show_asset,
            "show_accommodation": self.show_accommodation,
            "show_cost": self.show_cost,
            "employee_ids": self.employee_ids.ids,
            "asset_ids": self.asset_ids.ids,
            "accommodation_ids": self.accommodation_ids.ids,
            "account_cost_center_ids": self.account_cost_center_ids.ids,
            "account_journal_code_ids": self.journal_code_ids.ids,
