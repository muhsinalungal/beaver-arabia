...
class TrialBalanceReport(models.AbstractModel):
    ...
    def _compute_account_amount(
        ...
        # total_amount["total_initial_balance"] = 0.0
        # total_amount["total_balance"] = 0.0
        # total_amount["total_ending_balance"] = 0.0
        for tb in tb_period_acc:
            ...
            # total_amount["total_credit"] += tb["credit"]
            # total_amount["total_debit"]  += tb["debit"]
            # total_amount["total_balance"]  += tb["balance"]
            # total_amount["total_initial_balance"] = 0.0
            # total_amount["total_ending_balance"] += tb["balance"]
            if foreign_currency:
        ...
        for tb in tb_initial_acc:
            ...
            if acc_id not in total_amount.keys():
                ...
                # total_amount[acc_id]["total_credit"] += 0.0
                # total_amount[acc_id]["total_debit"] += 0.0
                # total_amount[acc_id]["total_balance"] += 0.0
                # total_amount[acc_id]["total_initial_balance"] = tb["balance"]
                # total_amount[acc_id]["total_ending_balance"] += tb["balance"]
    ...
    def _compute_acc_prt_amount(
        ...
        total_amount[acc_id][prt_id]["total_credit"] = 0.0
        total_amount[acc_id][prt_id]["total_debit"] = 0.0
        total_amount[acc_id][prt_id]["total_balance"] = 0.0
        total_amount[acc_id][prt_id]["total_initial_balance"] += tb["balance"]
        total_amount[acc_id][prt_id]["total_ending_balance"] += tb["balance"]
        if foreign_currency:
    ...
    def _get_data(
        ...
        if unaffected_id:
            if unaffected_id not in accounts_ids:
                ...
                # total_amount[unaffected_id]["total_initial_balance"] = 0.0
                # total_amount[unaffected_id]["total_balance"] = 0.0
                # total_amount[unaffected_id]["total_credit"] = 0.0
                # total_amount[unaffected_id]["total_debit"] = 0.0
                # total_amount[unaffected_id]["total_ending_balance"] = 0.0
                if foreign_currency:
    ...
    def _get_groups_data(self, accounts_data, total_amount, foreign_currency):
        ...
        for group_id in account_group_relation.keys():
            for account_id in account_group_relation[group_id]:
                ...
                groups_data[group_id]["total_initial_balance"] += total_amount[account_id][
                    "total_initial_balance"
                ]
                # groups_data[group_id]["total_debit"] += total_amount[account_id]["total_debit"]
                # groups_data[group_id]["total_credit"] += total_amount[account_id]["total_credit"]
                # groups_data[group_id]["total_balance"] += total_amount[account_id]["total_balance"]
                # groups_data[group_id]["total_ending_balance"] += total_amount[account_id][
    ...
    def _get_report_values(self, docids, data):
        ...
        if not show_partner_details:
                ...
                accounts_data[account_id].update(
                    {
                        ...
                        # "total_initial_balance": total_amount[account_id]["total_initial_balance"],
                        # "total_credit": total_amount[account_id]["total_credit"],
                        # "total_debit": total_amount[account_id]["total_debit"],
                        # "total_balance": total_amount[account_id]["total_balance"],
                        # "total_ending_balance": total_amount[account_id]["total_ending_balance"],
                        "type": "account_type",
                    }

                )
                total_credit += total_amount[account_id]["credit"]
                total_debit += total_amount[account_id]["debit"]
                total_balance += total_amount[account_id]["balance"]
                total_initial_balance += total_amount[account_id]["initial_balance"]
                total_ending_balance += total_amount[account_id]["ending_balance"]
                vals = {
            ...
            total_trial_balance.append(vals)
        else:
            if foreign_currency:
                for account_id in accounts_data.keys():
