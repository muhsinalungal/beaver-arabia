...
class MisBuilderXlsx(models.AbstractModel):
    ...
    def generate_xlsx_report(self, workbook, data, objects):
        ...
        if objects[0].head_name == 'dept_wise':
            ...
            name = 'Income Statement - Comparitive'

                              
        sheet.write(row_pos, 0, "GAMBIT GULF CONTRACTING CO. LTD.", bold)
        row_pos += 1
        sheet.write(row_pos, 0, name, bold)
        row_pos += 1
        sheet.write(row_pos, 0, objects[0].note, bold)
        row_pos += 2
