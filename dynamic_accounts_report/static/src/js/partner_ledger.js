odoo.define('dynamic_accounts_report.partner_ledger', function (require) {
    ...
    template: 'PartnerTemp',
                ...
                try{
                    ...
                    self._rpc({
                        ...
                        if (initial_render) {
                            ...
                            console.log(self.$el.find('.partners'))
        ...
        apply_filter: function(event) {
            ...
            var invoice_type_res = document.getElementById("invoice_type_res")
            ...
            for (var i = 0; i < invoice_type_list.length; i++) {
                if(invoice_type_list[i].element[0].selected === true){
                    ...
                    invoice_type_res.value = invoice_type_text
                    invoice_type_res.innerHTML=invoice_type_res.value;
                }
            }
            if (invoice_type_list.length == 0){
               invoice_type_res.value = ""
                    invoice_type_res.innerHTML="";
            }
