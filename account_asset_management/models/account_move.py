        ...
        for move in self:
            ...
            if move.move_type == 'in_invoice':
                for aml in move.line_ids.filtered("asset_id"):
                    if aml.asset_id.purchase_value == 0.00 and aml.account_id.fixed_assets == True:
                        aml.asset_id.purchase_value = aml.balance
                        aml.asset_id.date_start = move.invoice_date
