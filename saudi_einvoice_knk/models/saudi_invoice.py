...
class AccountMove(models.Model):
    ...
    def amount_word(self, amount):
        ...
        amount = before_amount_words + ' ' + 'Saudi Riyals' + ' ' + 'and' + ' ' + after_amount_words + ' ' + 'Halalas'
        return amount
